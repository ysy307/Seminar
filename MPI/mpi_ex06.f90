program sendrecv
  ...
  if( myrank == 0 ) then
    call MPI_Sendrecv( a0(0), N, MPI_DOUBLE_PRECISION, 1, 100, &
  &                    a1(0), N, MPI_DOUBLE_PRECISION, 1, 200, &
  &                    MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr )
  else
    call MPI_Sendrecv( a0(0), N, MPI_DOUBLE_PRECISION, 0, 200, &
  &                   a1(0), N, MPI_DOUBLE_PRECISION, 0, 100, &
  &                   MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierr )
  endif
